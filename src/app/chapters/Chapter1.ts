...
export const Chapter1: Chapter = {
    story: [
        `You enter the woods, chasing after the goblin who stole your father's sword. You lose sight of them in the thick woods and egin to creep forward, relying on your ears to warn you of danger and hopefully to locate the thieving goblin.`,
    ...
    enemyParty: [
        new Monster("Goblin", 5, {attack: 2, sneak: 0, persuade: 0}, {attack: 10, sneak: 10, persuade: 10}, 1, 3, "../../assets/images/creatures/goblin.png")
    ],
